...
public class HelpActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		...
		android.graphics.drawable.GradientDrawable gd2 = new android.graphics.drawable.GradientDrawable(); gd2.setColor(Color.parseColor("#FFFFFF")); gd2.setCornerRadius(30); linear4.setBackground(gd2);
	}
