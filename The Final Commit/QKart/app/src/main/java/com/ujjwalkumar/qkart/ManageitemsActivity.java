...
public class ManageitemsActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		android.graphics.drawable.GradientDrawable gd1 = new android.graphics.drawable.GradientDrawable(); gd1.setColor(Color.parseColor("#FF1744")); gd1.setCornerRadius(30); linearproceed.setBackground(gd1);
			...
			imageviewop.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					if (textviewqty.getText().toString().equals("0")) {
						...
						t = 0;
						for(int _repeat54 = 0; _repeat54 < (int)(cart.size()); _repeat54++) {
