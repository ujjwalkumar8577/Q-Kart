...
public class HomeActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		android.graphics.drawable.GradientDrawable gd1 = new android.graphics.drawable.GradientDrawable(); gd1.setColor(Color.parseColor("#FFFFFF")); gd1.setCornerRadius(50); linearinfo.setBackground(gd1);
		...
		if (sp1.getString("lastorder", "").equals("")) {
			...
			if ((days > 2) || (days == 2)) {
				...
				textviewstatus.setText("You placed an ordered within 48 hours.\nPlease come back later.");
			}
		}
	}
