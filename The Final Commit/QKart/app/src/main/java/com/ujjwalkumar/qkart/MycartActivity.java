...
public class MycartActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		android.graphics.drawable.GradientDrawable gd1 = new android.graphics.drawable.GradientDrawable(); gd1.setColor(Color.parseColor("#FF1744")); gd1.setCornerRadius(30); linearplaceorder.setBackground(gd1);
		s = 0;
		lineardetail.setVisibility(View.GONE);
		textviewshowhide.setText("Show details");
